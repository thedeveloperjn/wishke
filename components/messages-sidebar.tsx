...
export default function MessagesSidebar() {
  ...
  return (
    <aside
      ref={sidebarRef}
      className={`hidden w-[24%] min-w-[270px]  xl:min-w-[320px] maxw200 flex-col bg-white p-4 lg:flex overflow-y-auto h-[calc(85vh)] pb-6 no-scrollbar shadow-sm transition-all duration-200 ${
